...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Eric Tendian Curriculum Vitae</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Curriculum Vitae for Eric Tendian">
...
<div class="span4">
	...
	<div class="well">
		...
		<a class="pull-right btn btn-small btn-inverse" href="http://">View Full Press <i class="icon-arrow-right icon-white"></I></a><br />
	</div>
	</div>-->
	</div>
